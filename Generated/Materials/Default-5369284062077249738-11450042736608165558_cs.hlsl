...
{
    const float4 variable0 = float4(1, 1, 1, 1); 
EvaluatedMaterial materialResult;
materialResult.Setup();
materialResult.albedo = variable0;
materialResult.metallic = 0;
materialResult.roughness = 0.9;
materialResult.normal = float3(0.5, 0.5, 1);
materialResult.emissive = float3(0, 0, 0);
